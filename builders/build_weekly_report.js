...
fs.writeFileSync(path.join(OUT, `ai_value_chain_baseline_${ASOF}.json`), JSON.stringify(updatedBaseline, null, 2), 'utf8');
...
fs.writeFileSync(path.join(OUT, `weekly_report_${ASOF}.md`), reportMarkdown + stateBlock, 'utf8');
...
fs.writeFileSync(path.join(OUT, `ai_weekly_payload_${ASOF}.json`), JSON.stringify(payload, null, 2), 'utf8');
